export const HONOR_CATALOG = [
  ...
  {
    honorId:"H011", name:"四人局之王", grade:"B", category:"专项能力", points:10,
    unit:"分", allowTie:false,
    rule:"依次比较：单赛季四人局总积分、四人局MVP场次、四人局正分率。至少参加1场四人局。"
  },
  {
    honorId:"H012", name:"五人局之王", grade:"B", category:"专项能力", points:10,
    unit:"分", allowTie:false,
    rule:"依次比较：单赛季五人局总积分、五人局MVP场次、五人局正分率。至少参加1场五人局。"
  },
  {
    honorId:"H005", name:"稳定先生", grade:"B", category:"专项能力", points:10,
    unit:"%", allowTie:false,
  ...
  {
    honorId:"H010", name:"独赢王", grade:"B", category:"专项能力", points:10,
    unit:"场", allowTie:false,
    rule:"独赢指本人积分≥0且同场其他所有实际参赛牌手均＜0。依次比较：独赢场次、独赢场次累计积分、独赢场次场均积分。全员均为0次则不颁发。"
  },
  {
    honorId:"H008", name:"大场面先生", grade:"B", category:"专项能力", points:10,
  ...
  {
    honorId:"H016", name:"大胜专家", grade:"B", category:"专项能力", points:10,
    unit:"场", allowTie:false,
    rule:"大胜场次＝本人单场积分－其他实际参赛牌手单场平均积分≥100，每场最多计1次。依次比较：大胜场次、这些场次累计统治分差、单场最大统治分差。全员均为0次则不颁发。"
  },
  {
    honorId:"H006", name:"连庄王", grade:"B", category:"专项能力", points:10,
    unit:"场", allowTie:false,
